  ...
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] my-[8ch] space-y-10'>
        ...
        <label htmlFor="fullname" className="block mb-2 font-semibold">
            ...
            <input type="number" id='fullname' placeholder='John Doe' name='fullname' className="w-full appearance none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
        </div>
        <div className=''>
        <label htmlFor="email" className="block mb-2 font-semibold">
                Email Address
            </label>
            <input type="number" id='email' placeholder='johndoe@gmail.com' name='email' className="w-full appearance none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
            <small className="block mt-1 text-xs text-neutral-500 dark:text-neutral-600 font-normal">
                You will get your tickets via email
            </small>
        </div>
        <div className=''>
        <label htmlFor="phone" className="block mb-2 font-semibold">
            ...
            <input type="number" id='phone' placeholder='+234 (808) 463 3447' name='phone' className="w-full appearance none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
        </div>
        <div className=''>
        <label htmlFor="altphone" className="block mb-2 font-semibold">
                Alternative phone number
            </label>
            <input type="number" id='altphone' placeholder='+234 (307) 459 3289' name='altphone' className="w-full appearance none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/60 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
        </div>
                </form> 
            </div>
