...
const Bus = () => {
  return (
    <div className='w-full lg:px-28 md:px-16 sm:px-7 px-4 mt-[13ch] my-[8ch] space-y-14'>
        ...
        <input type="text" id='seat' placeholder='Search buses...' name='seat' className="w-full appearance none text-neutral-800 dark:text-neutral-100 placeholder:text-neutral-400 dark:placeholder:text-neutral-600 inline-block bg-neutral-200/60 dark:bg-neutral-900/70 px-3 h-12 border border-neutral-200 dark:border-neutral-900 rounded-md focus:outline-none focus:bg-neutral-100 dark:focus:bg-neutral-900" />
...
<div className="w-full grid grid-cols-3 gap-10">
    ...
    <div className="px-3 py4 space-y-2">
    ...
    <Link to={"/bus/bus-details2"} className="w-full bg-neutral-200/60 dark:bg-neutral-900/40 rounded-xl p-4">
    ...
    <Link to={"/bus/bus-details3"} className="w-full bg-neutral-200/60 dark:bg-neutral-900/40 rounded-xl p-4">
