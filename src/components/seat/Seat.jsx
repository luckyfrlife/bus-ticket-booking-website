...
//   const handlSeatClick = (seatNumber) => {
...
const BusSeatLayout = () => {
  ...
  const seats = renderSeats(); // ✅ Store seats once and reuse
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="!mt-5 flex items-center gap-x-4">
        ...
        <p className="text-lg font-medium">₦ {selectedSeats.length * 400}</p>
        <span className="text-sm text-neutral-400 dark:text-neutral-600 font-normal">
          (Including all taxes)
        </span>
      </div>
