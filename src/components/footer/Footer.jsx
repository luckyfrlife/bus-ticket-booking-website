    ...
    <footer className="w-full lg:px-28 md:px-16 sm:px-7 px-4 py-8 bg-neutral-200/60 dark:bg-neutral-900/70">
      <div className="grid grid-cols-5 gap-5">
        ...
        <div className="space-y-7">
          ...
          <ul className="space-y-2 text-neutral-600 dark:text-neutral-500 text-base font-normal">
            <li>
              <Link to="#" className='hover:text-violet-600 ease-in-out duration-300'>Shuttle Booking</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-violet-600 ease-in-out duration-300'>Seat Selection</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-violet-600 ease-in-out duration-300'>Delay NOtifications</Link>
            </li>
            <li>
              <Link to="#" className='hover:text-violet-600 ease-in-out duration-300'>Feedback & Support</Link>
            </li>
          </ul>
        </div>
            ...
            <div className="flex gap-x-2">
              ...
              <div className="flex flex-col">
                ...
                <p className="text-sm text-neutral-700 dark:text-neutral-400">
                  Univeristy of Ilroin, Kwara State
                </p>
              </div>
            </div>
